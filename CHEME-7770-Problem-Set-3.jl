...
Looking at the metabolites crossing the boundaries of our system, we have aspartate, fumarate, carbamoyl phosphate, and urea.
...
aspartate                       10.0         0.0
fumarate                        0.0         30.0
carbamoyl phosphate             42.5         0.0
urea                            0.0         22.5

Obtained the above estimates for concentration values from Bionumbers website (https://bionumbers.hms.harvard.edu/search.aspx)
Assuming cells are spherical 
...
begin
	...
	# replacement flag -
	replacement_strategy_flag = 0 # use 0's, 1 if geometric mean
	...
	# build table of metabolites concentrations (M) for the metabolites in our model -
...
begin
	...
	# computation for C2 goes here ...
	S_C2 = S
	flux_bounds_array_C2 = flux_bounds_array
	
	# compute the flux -
	result_case_2 = lib.flux(S_C2,flux_bounds_array_C2,species_bounds_array,c_vector);
